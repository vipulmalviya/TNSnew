    ...
    return (
        <div className='wathlistOptions position-absolute d-flex align-items-center justify-content-center'>
            <ul className='h-100 d-flex align-items-center justify-content-center flex-column'>
                <li onClick={updateFunc}><div className='d-flex align-items-center justify-content-start'><img  src={icon1} alt="icone" /><p >{prop1}</p> </div></li>
                <li onClick={deletefunc}><div className='d-flex align-items-center justify-content-start'> <img  src={icon2} alt="icone" /><p>{prop2}</p></div></li>

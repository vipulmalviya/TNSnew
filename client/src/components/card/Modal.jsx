                ...
                <div className='modal_warrper d-flex align-items-center justify-content-between'>
                    <div className='modal-right flex-column d-flex align-items-start justify-content-between'>
                        ...
                        <div className='d-flex align-items-center justify-content-start gap-3' >
                            <Button onclick={onclick} linkprop={link1}>{prop ? "continue" : "save"}</Button>
                    ...
                    <div className='modal-left d-flex flex-column align-items-center justify-content-between'>
                        ...
                        <div className='watchlistAvatar'>
                                <img loading='lazy' height={"60px"} width={"60px"} src="https://media.istockphoto.com/id/1222357475/vector/image-preview-icon-picture-placeholder-for-website-or-ui-ux-design-vector-illustration.jpg?s=612x612&w=0&k=20&c=KuCo-dRBYV7nz2gbk4J9w1WtTAgpTdznHu55W9FjimE=" alt="" />
                        </div>

...
const TastePage = () => {
  ...
  function alertfunc(params) {
    if (value.length <= 0) {
      toast.error('This input filld is also required', {
        position: "top-right",
        autoClose: 5000,
        ...
        <div className="containerSm flex-column d-flex justify-content-start align-content-center" style={{ gap: "30px", }}>
          ...
          <div className='innerdivtwo' >
            ...
            <div style={{ marginTop: "30px", }}>
              <Button2 onclick={alertfunc} propdata1={handleError1} propdata2={handleError2} propdata3={value.length <= 0} linkprop={"/moodPage"}>Continue</Button2>
            </div>
          </div>
